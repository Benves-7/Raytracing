...
\documentclass[12pt, % Default font size, values between 10pt-12pt are allowed
    % letterpaper, 
    % Uncomment for US letter paper size
    ]{fphw}
...
%----------------------------------------------------------------------------------------
\title{Optimization of raytracer} % Assignment title
\author{Benjamin Vesterlund} % Student name
\institute{Luleå University of Technology (LTU)} % Institute or school name
\class{S0017D Spelkonsoler och system} % Course or class name
\professor{Fredrik Lindahl} % Professor or teacher in charge of the assignment
